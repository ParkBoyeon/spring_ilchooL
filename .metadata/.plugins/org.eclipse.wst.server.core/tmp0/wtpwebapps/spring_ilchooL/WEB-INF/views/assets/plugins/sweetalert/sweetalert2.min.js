! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Sweetalert2 = t() }(this, function() {
    ...
    var e = { title: "", titleText: "", text: "", html: "", type: null, toast: !1, customClass: "", target: "body", backdrop: !0, animation: !0, allowOutsideClick: !0, allowEscapeKey: !0, allowEnterKey: !0, showConfirmButton: !0, showCancelButton: !1, preConfirm: null, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: "#3085d6", confirmButtonClass: null, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: "#aaa", cancelButtonClass: null, buttonsStyling: !0, reverseButtons: !1, focusConfirm: !0, focusCancel: !1, showCloseButton: !1, closeButtonAriaLabel: "Close this dialog", showLoaderOnConfirm: !1, imageUrl: null, imageWidth: null, imageHeight: null, imageAlt: "", imageClass: null, timer: null, width: 500, padding: 20, background: "#fff", input: null, inputPlaceholder: "", inputValue: "", inputOptions: {}, inputAutoTrim: !0, inputClass: null, inputAttributes: {}, inputValidator: null, grow: !1, position: "center", progressSteps: [], currentProgressStep: null, progressStepsDistance: "40px", onBeforeOpen: null, onOpen: null, onClose: null, useRejections: !1, expectRejections: !1 },
        ...
        s = function(e) { console.error("SweetAlert2: " + e) },
        l = [],
        u = function(e) {-1 === l.indexOf(e) && (l.push(e), a(e)) },
        c = { previousActiveElement: null, previousBodyPadding: null },
        d = function(e) {
            var t = f();
            t && (t.parentNode.removeChild(t), T(document.body, o["no-backdrop"]), T(document.body, o["has-input"]), T(document.body, o["toast-shown"])); {
                if ("undefined" != typeof document) {
                    ...
                    var r = m(),
                        ...
                        c = q(r, o.select),
                        d = r.querySelector("." + o.checkbox + " input"),
                        b = q(r, o.textarea);
                    r.setAttribute("aria-live", e.toast ? "polite" : "assertive");
                    var h = function() { Q.isVisible() && Q.resetValidationError() };
                    return i.oninput = h, a.onchange = h, c.onchange = h, d.onchange = h, b.oninput = h, l.oninput = function() { h(), u.value = l.value }, l.onchange = function() { h(), l.previousSibling.value = l.value }, r
                }
        ...
        f = function() { return document.body.querySelector("." + o.container) },
        m = function() { return f() ? f().querySelector("." + o.popup) : null },
        b = function(e) { return f() ? f().querySelector("." + e) : null },
        h = function() { return b(o.title) },
        g = function() { return b(o.content) },
        v = function() { return b(o.image) },
        y = function() { return b(o.progresssteps) },
        w = function() { return b(o.validationerror) },
        C = function() { return b(o.confirm) },
        x = function() { return b(o.cancel) },
        k = function() { return b(o.buttonswrapper) },
        S = function() { return b(o.close) },
        A = function() {
            var e = Array.from(m().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function(e, t) { return e = parseInt(e.getAttribute("tabindex")), t = parseInt(t.getAttribute("tabindex")), e > t ? 1 : e < t ? -1 : 0 }),
                t = Array.prototype.slice.call(m().querySelectorAll('button, input:not([type=hidden]), textarea, select, a, [tabindex="0"]'));
            return function(e) { var t = []; for (var n in e) - 1 === t.indexOf(e[n]) && t.push(e[n]); return t }(e.concat(t))
        },
        B = function() { return !document.body.classList.contains(o["toast-shown"]) },
        P = function(e, t) { return !!e.classList && e.classList.contains(t) },
        E = function(e) {
        ...
        L = function(e, t) { if (e && t) { t.split(/\s+/).filter(Boolean).forEach(function(t) { e.classList.add(t) }) } },
        T = function(e, t) { if (e && t) { t.split(/\s+/).filter(Boolean).forEach(function(t) { e.classList.remove(t) }) } },
        q = function(e, t) {
            for (var n = 0; n < e.childNodes.length; n++)
                if (P(e.childNodes[n], t)) return e.childNodes[n]
        },
        O = function(e, t) { t || (t = e === m() || e === k() ? "flex" : "block"), e.style.opacity = "", e.style.display = t },
        V = function(e) { e.style.opacity = "", e.style.display = "none" },
        N = function(e) { return e.offsetWidth || e.offsetHeight || e.getClientRects().length },
        j = function() {
    ...
    var W = function(e) { for (var t in e) Q.isValidParameter(t) || a('Unknown parameter "' + t + '"'), Q.isDeprecatedParameter(t) && u('The parameter "' + t + '" is deprecated and will be removed in the next major release.') },
        z = function(t) {
            ...
            if (t.titleText ? A.innerText = t.titleText : A.innerHTML = t.title.split("\n").join("<br />"), t.backdrop || L(document.body, o["no-backdrop"]), t.text || t.html) {
                if ("object" === M(t.html))
                    if (B.innerHTML = "", 0 in t.html)
                        for (var j = 0; j in t.html; j++) B.appendChild(t.html[j].cloneNode(!0));
            ...
            var R = y(),
                I = parseInt(null === t.currentProgressStep ? Q.getQueueStep() : t.currentProgressStep, 10);
            t.progressSteps.length ? (O(R), function(e) { for (; e.firstChild;) e.removeChild(e.firstChild) }(R), I >= t.progressSteps.length && a("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(function(e, n) {
            ...
            if (t.type) {
                var W = !1;
                for (var z in r)
                    if (t.type === z) { W = !0; break } if (!W) return s("Unknown alert type: " + t.type), !1;
        ...
        Q = function e() {
            ...
            if ("undefined" != typeof window) {
                ...
                switch (M(n[0])) {
                    ...
                    case "object":
                        if (W(n[0]), H(a, n[0]), a.extraParams = n[0].extraParams, "email" === a.input && null === a.inputValidator) {
                            var l = function(e) { return new Promise(function(t, n) { /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? t() : n("Invalid email address") }) };
                            a.inputValidator = a.expectRejections ? l : e.adaptInputValidator(l)
                        }
                        if ("url" === a.input && null === a.inputValidator) {
                            var u = function(e) { return new Promise(function(t, n) { /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(e) ? t() : n("Invalid URL") }) };
                ...
                return new Promise(function(t, n) {
                    var r = function(n) { e.closePopup(a.onClose), t(a.useRejections ? n : { value: n }) },
                        l = function(o) { e.closePopup(a.onClose), a.useRejections ? n(o) : t({ dismiss: o }) },
                        u = function(t) { e.closePopup(a.onClose), n(t) };
                    a.timer && (p.timeout = setTimeout(function() { return l("timer") }, a.timer));
                    var b = function(e) {
                    ...
                    for (var H = function(t) {
                            if (a.showLoaderOnConfirm && e.showLoading(), a.preConfirm) {
                                var n = Promise.resolve().then(function() { return a.preConfirm(t, a.extraParams) });
                                a.expectRejections ? n.then(function(e) { return r(e || t) }, function(t) { e.hideLoading(), t && e.showValidationError(t) }) : n.then(function(n) { N(w()) ? e.hideLoading() : r(n || t) }, function(e) { return u(e) })
                            } else r(t)
                        }, R = function(t) {
                                ...
                                case "click":
                                    if (c && e.isVisible())
                                        if (e.disableButtons(), a.input) {
                                            ...
                                            if (a.inputValidator) {
                                                e.disableInput();
                                                var f = Promise.resolve().then(function() { return a.inputValidator(p, a.extraParams) });
                                                a.expectRejections ? f.then(function() { e.enableButtons(), e.enableInput(), H(p) }, function(t) { e.enableButtons(), e.enableInput(), t && e.showValidationError(t) }) : f.then(function(t) { e.enableButtons(), e.enableInput(), t ? e.showValidationError(t) : H(p) }, function(e) { return u(e) })
                                            } else H(p)
                                        } else H(!0);
                    ...
                    S().onclick = function() { l("close") }, a.toast ? p.onclick = function(t) { t.target !== p || a.showConfirmButton || a.showCancelButton || a.allowOutsideClick && (e.closePopup(a.onClose), l("overlay")) } : d.onclick = function(e) { e.target === d && a.allowOutsideClick && l("overlay") };
                    var Q = k(),
                        Y = C(),
                        _ = x();
                    ...
                    }, e.getProgressSteps = function() { return a.progressSteps }, e.setProgressSteps = function(e) { a.progressSteps = e, z(a) }, e.showProgressSteps = function() { O(y()) }, e.hideProgressSteps = function() { V(y()) }, e.enableButtons(), e.hideLoading(), e.resetValidationError(), a.input && L(document.body, o["has-input"]);
                    for (var J = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], X = void 0, F = 0; F < J.length; F++) {
                        var G = o[J[F]],
                            ee = q(p, G);
                        if (X = b(J[F])) {
                            for (var te in X.attributes)
                                if (X.attributes.hasOwnProperty(te)) { var ne = X.attributes[te].name; "type" !== ne && "value" !== ne && X.removeAttribute(ne) } for (var oe in a.inputAttributes) X.setAttribute(oe, a.inputAttributes[oe])
                        }
                    ...
                    "select" !== a.input && "radio" !== a.input || (a.inputOptions instanceof Promise ? (e.showLoading(), a.inputOptions.then(function(t) { e.hideLoading(), re(t) })) : "object" === M(a.inputOptions) ? re(a.inputOptions) : s("Unexpected type of inputOptions! Expected object or Promise, got " + M(a.inputOptions))),
                        function(e, t, n) {
                            var r = f(),
                                i = m();
                            null !== t && "function" == typeof t && t(i), e ? (L(i, o.show), L(r, o.fade), T(i, o.hide)) : T(i, o.fade), O(i), r.style.overflowY = "hidden", j && !P(i, o.noanimation) ? i.addEventListener(j, function e() { i.removeEventListener(j, e), r.style.overflowY = "auto" }) : r.style.overflowY = "auto", L(document.documentElement, o.shown), L(document.body, o.shown), L(r, o.shown), B() && (K(), Z()), c.previousActiveElement = document.activeElement, null !== n && "function" == typeof n && setTimeout(function() { n(i) })
    ...
    return Q.isVisible = function() { return !!m() }, Q.queue = function(e) {
        I = e;
        var t = function() { I = [], document.body.removeAttribute("data-swal2-queue-step") },
            n = [];
        return new Promise(function(e, o) {! function o(r, i) { r < I.length ? (document.body.setAttribute("data-swal2-queue-step", r), Q(I[r]).then(function(a) { void 0 !== a.value ? (n.push(a.value), o(r + 1, i)) : (t(), e({ dismiss: a.dismiss })) })) : (t(), e({ value: n })) }(0) })
    }, Q.getQueueStep = function() { return document.body.getAttribute("data-swal2-queue-step") }, Q.insertQueueStep = function(e, t) { return t && t < I.length ? I.splice(t, 0, e) : I.push(e) }, Q.deleteQueueStep = function(e) { void 0 !== I[e] && I.splice(e, 1) }, Q.close = Q.closePopup = Q.closeModal = Q.closeToast = function(e) {
        var t = f(),
            n = m();
        if (n) {
            ...
            j && !P(n, o.noanimation) ? n.addEventListener(j, function e() { n.removeEventListener(j, e), P(n, o.hide) && r() }) : r(), null !== e && "function" == typeof e && setTimeout(function() { e(n) })
        }
    }, Q.clickConfirm = function() { return C().click() }, Q.clickCancel = function() { return x().click() }, Q.showLoading = Q.enableLoading = function() {
        var e = m();
        e || Q(""), e = m();
        var t = k(),
            n = C(),
    ...
    }, Q.isValidParameter = function(t) { return e.hasOwnProperty(t) || "extraParams" === t }, Q.isDeprecatedParameter = function(e) { return -1 !== t.indexOf(e) }, Q.setDefaults = function(e) {
    ...
    }, Q.resetDefaults = function() { R = H({}, e) }, Q.adaptInputValidator = function(e) { return function(t, n) { return e.call(this, t, n).then(function() {}, function(e) { return e }) } }, Q.noop = function() {}, Q.version = "7.0.5", Q.default = Q, Q
