(function() { /*VERSION:210514*/
    function checkWebviewCustomUA(a) {
        for (var b = ["daum", "naver", "google", "facebook", "twitter"], c = !1, d = 0, e = b.length; e > d; d++)
            if (a.indexOf(b[d]) > -1) { c = !0; break } return c
    }
    window.daum = window.daum || {},
        function(a) {
            function b(a) { var b = {}; return a.replace(/[?&]+([^=&]+)=*([^&]*)/gi, function(a, c, d) { b[c] = d }), b }
            ...
            for (var d = document.getElementsByTagName("script"), e = 0, f = d.length; f > e; ++e) {
                var g = d[e],
                    h = g.src;
                if (/\/mapjsapi\/bundle\/postcode\/(prod){0,1}(dev){0,1}(cbt){0,1}\/postcode.v2\.js\b/.test(h)) { c(b(h)) || (a.postcode._validParam_ = !1); break }
            }
            a.postcode.version = "210514", a.postcode.load = function(a) { a && "function" == typeof a && a() }
        ...
        function() {
            ...
            function str(a, b) {
                ...
                switch (i && "object" == typeof i && "function" == typeof i.toJSON && (i = i.toJSON(a)), "function" == typeof rep && (i = rep.call(b, a, i)), typeof i) {
                    ...
                    case "object":
                        if (!i) return "null";
                        if (gap += indent, g = [], "[object Array]" === Object.prototype.toString.apply(i)) { for (f = i.length, c = 0; f > c; c += 1) g[c] = str(c, i) || "null"; return e = 0 === g.length ? "[]" : gap ? "[\n" + gap + g.join(",\n" + gap) + "\n" + h + "]" : "[" + g.join(",") + "]", gap = h, e }
    ...
    postcodeUtils.param = function(a) {
        ...
        for (var d = 0, e = a.length; e > d; d++) {
            ...
            try { c[g[0]] = decodeURIComponent(g[1].replace(/\+/g, " ")) } catch (h) { c[g[0]] = g[1].replace(/\+/g, " ") }
        }
        return c
        ...
        var a = Array.prototype.slice.call(arguments),
            ...
            c = a.slice(0);
        if (c.length >= 1)
            for (var d = 0, e = c.length; e > d; d++) { var f = c[d]; for (var g in f) f.hasOwnProperty(g) && (b[g] = f[g]) }
        return b
    }, postcodeUtils.isArray = function(a) { var b = window.jQuery; if (a) { var c = Object.prototype.toString.call(a).toLowerCase(); if ("[object array]" === c || "[object nodelist]" === c || "[object htmlcollection]" === c || b && a instanceof b) return !0 } return !1 }, postcodeUtils.trim = function(a) {
        var b = /\s*((\S+\s*)*)/,
            c = /((\s*\S+)*)\s*/;
        return a.replace(b, "$1").replace(c, "$1")
    }, postcodeUtils.isUndefined = function(a) { return void 0 === a ? !0 : !1 }, postcodeUtils.isNull = function(a) { return null === a ? !0 : !1 }, postcodeUtils.isAvailable = function(a) { return postcodeUtils.isUndefined(a) || postcodeUtils.isNull(a) || "" === postcodeUtils.trim(a) ? !1 : !0 }, postcodeUtils.event = {
        isTouch: "ontouchstart" in window ? !0 : !1,
        on: function(a, b, c) { a && a.addEventListener ? a.addEventListener(b, c, !1) : a && a.attachEvent ? a.attachEvent("on" + b, c) : a && (a["on" + b] = c) },
        off: function(a, b, c) { a && a.removeEventListener ? a.removeEventListener(b, c, !1) : a && a.detachEvent ? a.detachEvent("on" + b, c) : a && (a["on" + b] = null) },
        ...
        onTouch: function(a, b) {
            ...
            }), this.on(a, "touchend", function(a) { h.stopPropagation(a), f && !g ? (f = !1, e && "function" == typeof e && e(a)) : (f = !1, g = !1) }))
        }
        ...
        for (var b = ["naver"], c = !1, d = 0, e = b.length; e > d; d++)
            if (a.indexOf(b[d]) > -1) { c = !0; break } return c
    }, postcodeUtils.isIOSWebview = function(a) { for (var b = ["version/7", "version/8", "version/9", "version/10", "version/11", "version/12", "version/13", "version/14", "version/15"], c = 0, d = 0, e = b.length; e > d; d++) - 1 === a.indexOf(b[d]) && c++; return c === b.length ? !0 : checkWebviewCustomUA(a) }, postcodeUtils.isDaumapps = function(a) { for (var b = ["daumapps"], c = 0, d = 0, e = b.length; e > d; d++) a.indexOf(b[d]) > -1 && c++; return c === b.length }, postcodeUtils.isMobileChrome = function(a) { for (var b = ["crios", "chrome"], c = 0, d = 0, e = b.length; e > d; d++) a.indexOf(b[d]) > -1 && c++; return c > 0 }, postcodeUtils.encodeData = function(a) { var b = ""; for (var c in a) a.hasOwnProperty(c) && (b += c + "=" + encodeURIComponent(a[c]) + "|"); return b = b.slice(0, b.length - 1) }, postcodeUtils.decodeData = function(a) {
        ...
        return null
    }, postcodeUtils.getStringByOptions = function(a, b, c) { var d = ""; for (var e in a) a.hasOwnProperty(e) && (d += e + b + a[e], d += c); return d = d.slice(0, d.length - 1) }, postcodeUtils.returnEmptyString = function(a) { return void 0 === a || null === a ? "" : a }, postcodeUtils.isHex = function(a) {
        var b = !1;
        if (a) {
            var c = /^#?([a-f\d])([a-f\d])([a-f\d])$/i;
            a = a.replace(c, function(a, b, c, d) { return b + b + c + c + d + d }), b = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.test(a)
        }
        return b
    ...
    ! function(a, b, c, d, e) {
        var f = b,
            g = f.userAgent;
        a.CONT = { MIN_WIDTH: 300, MIN_HEIGHT: 400, DEFAULT_WIDTH: 500, DEFAULT_HEIGHT: 500, ID_PREFIX: "__daum__", EMPTY_FUNCTION: function() {}, PROTOCOL: e.protocol, FRAME_POPUP: "popup", FRAME_LAYER: "layer", POPUP_CLOSE_STATE: { COMPLETE: "COMPLETE_CLOSE", FORCE: "FORCE_CLOSE" } }, a.MODEL = { VIEWER_COUNT: 0, ID_MAP: {}, TARGET_MAP: {}, POPUP_MAP: {} }, a.viewUtils = function() {
            function b(a, b, d, e, f, h) { "msie" !== g.browser.name || 7 !== parseInt(g.browser.version.major, 10) || c.postMessage ? "msie" !== g.browser.name || 6 !== parseInt(g.browser.version.major, 10) || c.postMessage || (h += 60, a.document.getElementById(e).style.height = h - 4 + "px", a.document.getElementById(e).style.width = b.offsetWidth - 4 + "px", b.style.height = h + "px", d.style.height = h + "px") : (a.document.getElementById(e).style.height = h - 4 + "px", a.document.getElementById(e).style.width = b.offsetWidth - 4 + "px", b.style.height = h + "px", d.style.height = h + "px") }
            ...
            function e(a, b, c) {
                ...
                if (a && !isNaN(a)) a = parseInt(a, 10) < c ? c : parseInt(a, 10);
                    ...
                    d = !1;
                    var e = parseInt(a.replace(/^(\d+)px$/, function(a, b, c) { return b }), 10);
                    a = c > e ? c : e
                } else a = b;
                else a = b;
            ...
            function j(a, b) {
                if (b) {
                    ...
                    for (var e in q.TARGET_MAP)
                        if (a === q.TARGET_MAP[e]) { c = e; break } c && k(a, d.getElementById(c)), a ? (a.appendChild(b), q.TARGET_MAP[b.id] = a) : (d.body.appendChild(b), q.TARGET_MAP[b.id] = d.body)
                }
            }

            function k(a, b) { b && (a ? q.TARGET_MAP[b.id] === a && (a.removeChild(b), q.TARGET_MAP[b.id] = null) : (d.body.removeChild(b), q.TARGET_MAP[b.id] = null)) }
            ...
            function m(a, b) { n(a, b) || (q.POPUP_MAP[a] || (q.POPUP_MAP[a] = []), q.POPUP_MAP[a].push({ ref: b, data: { closeCallbackTimer: -1 } })) }
            ...
            var q = a.MODEL;
            return { append: j, remove: k, setPopupMap: m, getPopupMap: o, setFrameStyle: function(a, b) { i(a), h(b) }, adjustLowIE: b, getNormalizeSize: e, getValidationUrl: l, IE11CompatibleBugFix: p }
        }(), a.common = function() {
            function b(a) {
                var b = {},
                    c = "done" === a.action ? !0 : !1;
            ...
            function e(a, b) { var c = a + "_" + b; return i.ID_MAP[c] }
        ...
        a.frame = function() {
            ...
            function b(a) {
                var b = d.createElement("div"),
                    c = null;
                return c = f.userAgent.os.ios ? parseInt(f.userAgent.browser.version.major, 10) >= 13 ? { position: "relative", width: a.isFlexibleWidth ? a.width : a.width + "px", height: a.isFlexibleHeight ? a.height : a.height + "px", "background-color": "#fff", "z-index": "0", overflow: "hidden", "min-width": "300px", margin: "0", padding: "0" } : { position: "relative", width: a.isFlexibleWidth ? a.width : a.width + "px", height: a.isFlexibleHeight ? a.height : a.height + "px", "background-color": "#fff", "z-index": "0", "overflow-x": "hidden", "overflow-y": "auto", "min-width": "300px", margin: "0", padding: "0" } : { position: "relative", width: a.isFlexibleWidth ? a.width : a.width + "px", height: a.isFlexibleHeight ? a.height : a.height + "px", "background-color": "#fff", "z-index": "0", overflow: "hidden", "min-width": "300px", margin: "0", padding: "0" }, b.style.cssText = f.getStringByOptions(c, ":", ";"), b
            }

            function e() {
                var a = d.createElement("iframe"),
                    b = { position: "absolute", left: "0", top: "0", width: "100%", height: "100%", border: "0 none", margin: "0", padding: "0", overflow: "hidden", "min-width": "300px" };
                return f.userAgent.os.ios && f.isIOSWebview(f.userAgent.ua_string) && (b = { width: "100%", height: "100%", border: "0 none", margin: "0", padding: "0", overflow: "hidden", "min-width": "300px" }), a.setAttribute("frameborder", "0"), a.style.cssText = f.getStringByOptions(b, ":", ";"), a
            }
            ...
            function k(a, c) {
                ...
                var d = b(a),
                    g = e();
                return d.id = j.setId("layer", a.viewerNo), g.src = "about:blank", d.appendChild(g), h.append(c, d), f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string) ? setTimeout(function() { l(g, d, a, c) }, 300) : setTimeout(function() { l(g, d, a, c) }, 0), d
            }
            ...
            function l(b, c, d, e) {
                ...
                f.document.write(a(d)), h.setFrameStyle(f.document.getElementsByTagName("html")[0], f.document.getElementsByTagName("body")[0]), f.document.close(), j.setReady(f, function(a, i) {
                    ...
                    } else "search" === a ? d.onSearch !== g.EMPTY_FUNCTION && d.onSearch(i) : "resize" === a ? d.onResize !== g.EMPTY_FUNCTION && (d.onResize(i), h.adjustLowIE(f, b, c, j.getId("viewerFrame", d.viewerNo), i.width, i.height)) : "done" === a && d.onComplete !== g.EMPTY_FUNCTION && setTimeout(function() { d.onComplete(i), d.autoClose && (h.IE11CompatibleBugFix(f), h.remove(e, c), d.onClose !== g.EMPTY_FUNCTION && d.onClose(g.POPUP_CLOSE_STATE.COMPLETE)) }, 0)
                }, d)
            }

            function m(a) {
                if (null === q) return alert("POPUP URL을 셋팅해 주세요.");
                var b = { toolbar: "no", scrollbars: "no", menubar: "no", titlebar: "no", resizable: "no", location: "no", status: "no", top: isNaN(a.top) ? 200 : a.top, left: isNaN(a.left) ? 500 : a.left, width: a.isFlexibleWidth ? g.DEFAULT_WIDTH : a.width, height: a.isFlexibleHeight ? g.DEFAULT_HEIGHT : a.height },
                ...
                if (a.popupName && o(e), f.userAgent.os.android && f.isAndroidWebview(f.userAgent.ua_string)) {
                    ...
                    setTimeout(function() { n(e, a), p(e, a) }, k)
                } else setTimeout(function() { n(e, a), p(e, a) }, 0);
                return e
            }
            ...
            function n(b, c) {
                ...
                } catch (m) {} j.setReady(d, function(a, d) {
            ...
            var q = null,
                ...
                s = null;
            return {
                init: function(a, b, c) { q = a, r = b || "", s = c || "" },
                popup: { create: function(a) { m(a) } },
                layer: {
                    create: function(a, b) {
                        var c = null;
    ...
    ! function(a, b, c, d, e) {
        ...
        a.themePreprocessor = function() {
            ...
            function c(a, b) { for (var c = "", d = 0, e = a.length; e > d && !(c = b[a[d]]); d++); return c }
            ...
            function l(a) { a = Math.round(a); var b = a.toString(16); return 1 == b.length ? "0" + b : b }

            function m(a, b, c) { return "#" + l(a) + l(b) + l(c) }
            ...
            function q(a, b, c) { return 0 > c && (c += 1), c > 1 && (c -= 1), 1 / 6 > c ? a + 6 * (b - a) * c : .5 > c ? b : 2 / 3 > c ? a + (b - a) * (2 / 3 - c) * 6 : a }
            ...
            var s = { BG: "bgColor", SEARCH_BG: "searchBgColor", CONTENT_BG: "contentBgColor", PAGE_BG: "pageBgColor", TEXT: "textColor", QUERY_TEXT: "queryTextColor", POSTCODE_TEXT: "postcodeTextColor", EMPH_TEXT: "emphTextColor", OUTLINE: "outlineColor" },
                t = {},
                u = [{ key: s.BG, match: ["BODY.bg"] }, { key: s.SEARCH_BG, match: ["SEARCH.bg"] }, { key: s.CONTENT_BG, match: ["SEARCH_GUIDE.bg", "FILTER_ADDRESS.bg", "RESULT_ADDRESS.bg", "INFO.bg", "INFO.iOSTouchGuideBoxBg", "LAYER.bg", "SUGGEST.bg"] }, { key: s.PAGE_BG, match: ["PAGING.bg"] }, { key: s.TEXT, match: ["SEARCH_GUIDE.text", "FILTER_ADDRESS.text", "RESULT_ADDRESS.addrText", "RESULT_ADDRESS.engMapBtnText", "RESULT_ADDRESS.autoMappingDontknowText", "RESULT_ADDRESS.moreRelAddrLabelText", "PAGING.curPageNumText", "INFO.text", "INFO.iOSTouchGuideBoxText", "LAYER.text", "SUGGEST.text"] }, { key: s.QUERY_TEXT, match: ["SEARCH.query"] }, { key: s.POSTCODE_TEXT, match: ["RESULT_ADDRESS.postcode"] }, { key: s.EMPH_TEXT, match: ["INFO.moveDaumMapText", "SEARCH_GUIDE.emphText", "RESULT_ADDRESS.hangJungDongText", "RESULT_ADDRESS.autoMappingGuideText", "RESULT_ADDRESS.buildingDetailText", "RESULT_ADDRESS.addrTypeLabelText", "SUGGEST.emphText"] }, { key: s.OUTLINE, match: ["SEARCH_GUIDE.topInfoBottomLine", "RESULT_ADDRESS.outline", "RESULT_ADDRESS.dividingLine", "RESULT_ADDRESS.relAddrDividingLine", "INFO.bottomLine", "INFO.iOSTouchGuideBoxOutline", "LAYER.outline", "SUGGEST.bottomLine", "SUGGEST.dividingLine"] }],
                v = [{
                    keys: [s.SEARCH_BG],
                    match: [
                ...
                getPreprocessResult: function(c) {
                    ...
                    if (d.isValid) {
                        ...
                        var g = a(e),
                            ...
                            i = j(e),
                            k = g && h;
                        if (k) return { themeStr: f.themeStringify(t), bit: i.background, sit: i.search, sgit: i.suggest, sbit: i.selectbox, pit: i.page, mit: i.more, lcit: i.layerClose }
                    }
                    return null
                }
            }
    ...
    ! function(a, b, c, d, e) {
        function f(a, b) {
            ...
            if (b) {
                var d = b.q,
                    e = !0;
                d && "string" == typeof d && "" !== m.trim(d) && (c = e === !0 ? m.extend(a, { region_name: encodeURIComponent(d), cq: encodeURIComponent(d), intsh: "on" }) : m.extend(a, { userQuery: encodeURIComponent(d), cq: encodeURIComponent(d) }))
            }
            return c
        }
        ...
        function j(a) {
            var b = ++o.VIEWER_COUNT,
                c = { width: n.DEFAULT_WIDTH, height: n.DEFAULT_HEIGHT, top: 50, left: 100, onComplete: n.EMPTY_FUNCTION, oncomplete: n.EMPTY_FUNCTION, onResize: n.EMPTY_FUNCTION, onresize: n.EMPTY_FUNCTION, onClose: n.EMPTY_FUNCTION, onclose: n.EMPTY_FUNCTION, onSearch: n.EMPTY_FUNCTION, onsearch: n.EMPTY_FUNCTION, autoMapping: !0, animation: !1, shorthand: !0, focusInput: !0, focusContent: !0, useBannerLink: !0, hideMapBtn: !1, hideEngBtn: !1, showMoreHName: !1, alwaysShowEngAddr: !1, pleaseReadGuide: 0, pleaseReadGuideTimer: 1.5, theme: null, allAddr: !1, zonecodeOnly: !0, useSuggest: !0, maxSuggestItems: 10, autoHiddenSuggest: !1, windowHeightAvailableForSuggest: 500, submitMode: !0 };
            m.extend(c, a, { viewerNo: b, timer: null, isFlexibleWidth: !1, isFlexibleHeight: !1, isLayerAutoPositioning: !0, isLayerDimmedClick: !0, indaum: !1, isViewerMode: !1, viewType: "none", banner: !0, autoClose: !0, autoHiddenSuggest: !1, zonecodeOnly: !0 });
            var d = p.getNormalizeSize(c.width, n.DEFAULT_WIDTH, n.MIN_WIDTH),
                e = p.getNormalizeSize(c.height, n.DEFAULT_HEIGHT, n.MIN_HEIGHT);
            if (c.width = d.value, c.isFlexibleWidth = d.isFlexible, c.height = e.value, c.isFlexibleHeight = e.isFlexible, c.onComplete && "function" == typeof c.onComplete && c.onComplete !== n.EMPTY_FUNCTION ? c.onComplete = c.onComplete : c.oncomplete && "function" == typeof c.oncomplete && c.oncomplete !== n.EMPTY_FUNCTION ? c.onComplete = c.oncomplete : (c.onComplete = n.EMPTY_FUNCTION, c.oncomplete = n.EMPTY_FUNCTION, c.isViewerMode = !0), c.onResize && "function" == typeof c.onResize && c.onResize !== n.EMPTY_FUNCTION ? c.onResize = c.onResize : c.onresize && "function" == typeof c.onresize && c.onresize !== n.EMPTY_FUNCTION ? c.onResize = c.onresize : (c.onResize = n.EMPTY_FUNCTION, c.onresize = n.EMPTY_FUNCTION), c.onClose && "function" == typeof c.onClose && c.onClose !== n.EMPTY_FUNCTION ? c.onClose = c.onClose : c.onclose && "function" == typeof c.onclose && c.onclose !== n.EMPTY_FUNCTION ? c.onClose = c.onclose : (c.onClose = n.EMPTY_FUNCTION, c.onclose = n.EMPTY_FUNCTION), c.onSearch && "function" == typeof c.onSearch && c.onSearch !== n.EMPTY_FUNCTION ? c.onSearch = c.onSearch : c.onsearch && "function" == typeof c.onsearch && c.onsearch !== n.EMPTY_FUNCTION ? c.onSearch = c.onsearch : (c.onSearch = n.EMPTY_FUNCTION, c.onsearch = n.EMPTY_FUNCTION), "boolean" != typeof c.autoMapping && (c.autoMapping = !0), "boolean" != typeof c.animation && (c.animation = !1), "boolean" != typeof c.shorthand && (c.shorthand = !0), "boolean" != typeof c.focusInput && (c.focusInput = !0), "boolean" != typeof c.focusContent && (c.focusContent = !0), "boolean" != typeof c.hideMapBtn && (c.hideMapBtn = !1), "boolean" != typeof c.hideEngBtn && (c.hideEngBtn = !1), "boolean" != typeof c.showMoreHName && (c.showMoreHName = !1), "boolean" != typeof c.alwaysShowEngAddr ? c.alwaysShowEngAddr = !1 : c.alwaysShowEngAddr && (c.hideEngBtn = !0), "boolean" != typeof c.submitMode && (c.submitMode = !0), "boolean" != typeof c.useSuggest && (c.useSuggest = !0), "boolean" != typeof c.autoHiddenSuggest && (c.autoHiddenSuggest = !1), isNaN(c.pleaseReadGuide) || "number" != typeof c.pleaseReadGuide ? c.pleaseReadGuide = 0 : (c.pleaseReadGuide = parseInt(c.pleaseReadGuide, 10), c.pleaseReadGuide <= 2 && (c.pleaseReadGuide = 0), c.pleaseReadGuide > 20 && (c.pleaseReadGuide = 20)), isNaN(c.pleaseReadGuideTimer) || "number" != typeof c.pleaseReadGuideTimer ? c.pleaseReadGuideTimer = 1.5 : (c.pleaseReadGuideTimer = parseFloat(c.pleaseReadGuideTimer), c.pleaseReadGuideTimer <= 0 && (c.pleaseReadGuideTimer = 1.5), c.pleaseReadGuideTimer > 60 && (c.pleaseReadGuideTimer = 1.5)), isNaN(c.maxSuggestItems) || "number" != typeof c.maxSuggestItems ? c.maxSuggestItems = 10 : (c.maxSuggestItems = parseInt(c.maxSuggestItems, 10), (c.maxSuggestItems < 1 || c.maxSuggestItems > 10) && (c.maxSuggestItems = 10)), c.windowHeightAvailableForSuggest = 45 * c.maxSuggestItems + 50, c.theme) {
        ...
        var l = function(a) { var b = a._validParam_; return function() { return b ? !1 : (alert("[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."), console && "function" == typeof console.error && console.error("[우편번호 서비스] API 로딩시 허용되지 않은 파라미터가 감지되어 API 작동이 중지되었습니다. 사이트 관리자분께서는 가이드페이지( https://postcode.map.daum.net/guide )의 기본 사용법을 참고하시어 수정 부탁드립니다."), !0) } }(k),
            m = b,
            n = a.CONT,
            o = a.MODEL,
            p = a.viewUtils,
