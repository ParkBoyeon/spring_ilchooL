! function(n, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.Sweetalert2 = t() }(this, function() {
    ...
    var n = { title: "", titleText: "", text: "", html: "", type: null, toast: !1, customClass: "", target: "body", backdrop: !0, animation: !0, allowOutsideClick: !0, allowEscapeKey: !0, allowEnterKey: !0, showConfirmButton: !0, showCancelButton: !1, preConfirm: null, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: "#3085d6", confirmButtonClass: null, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: "#aaa", cancelButtonClass: null, buttonsStyling: !0, reverseButtons: !1, focusConfirm: !0, focusCancel: !1, showCloseButton: !1, closeButtonAriaLabel: "Close this dialog", showLoaderOnConfirm: !1, imageUrl: null, imageWidth: null, imageHeight: null, imageAlt: "", imageClass: null, timer: null, width: 500, padding: 20, background: "#fff", input: null, inputPlaceholder: "", inputValue: "", inputOptions: {}, inputAutoTrim: !0, inputClass: null, inputAttributes: {}, inputValidator: null, grow: !1, position: "center", progressSteps: [], currentProgressStep: null, progressStepsDistance: "40px", onBeforeOpen: null, onOpen: null, onClose: null, useRejections: !1, expectRejections: !1 },
        ...
        u = Object.assign || function(n) { for (var t = 1; t < arguments.length; t++) { var e = arguments[t]; for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && (n[o] = e[o]) } return n },
        d = u({}, n),
        w = [],
        f = void 0,
        m = void 0;
    ...
    var b = function(n) { for (var t in n) k.isValidParameter(t) || r('Unknown parameter "' + t + '"'), k.isDeprecatedParameter(t) && c('The parameter "' + t + '" is deprecated and will be removed in the next major release.') },
        g = function(t) {
            ...
            e = s && l && s.parentNode !== l.parentNode ? v(t) : s || v(t);
            ...
            var f = S(),
                ...
                h = O(),
                y = N();
            if (t.titleText ? m.innerText = t.titleText : m.innerHTML = t.title.split("\n").join("<br />"), t.backdrop || I(document.body, o["no-backdrop"]), t.text || t.html) {
                if ("object" === p(t.html))
                    if (b.innerHTML = "", 0 in t.html)
                        for (var C = 0; C in t.html; C++) b.appendChild(t.html[C].cloneNode(!0));
                    else b.appendChild(t.html.cloneNode(!0));
                else t.html ? b.innerHTML = t.html : t.text && (b.textContent = t.text);
                D(b)
            } else U(b);
            if (t.position in o && I(f, o[t.position]), t.grow && "string" == typeof t.grow) {
                var P = "grow-" + t.grow;
                P in o && I(f, o[P])
            }
            t.showCloseButton ? (y.setAttribute("aria-label", t.closeButtonAriaLabel), D(y)) : U(y), e.className = o.popup, t.toast ? (I(document.body, o["toast-shown"]), I(e, o.toast)) : I(e, o.modal), t.customClass && I(e, t.customClass);
            var q = z(),
                Y = parseInt(null === t.currentProgressStep ? k.getQueueStep() : t.currentProgressStep, 10);
            t.progressSteps.length ? (D(q), W(q), Y >= t.progressSteps.length && r("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(function(n, e) {
                var a = document.createElement("li");
                if (I(a, o.progresscircle), a.innerHTML = n, e === Y && I(a, o.activeprogressstep), q.appendChild(a), e !== t.progressSteps.length - 1) {
                    var s = document.createElement("li");
                    I(s, o.progressline), s.style.width = t.progressStepsDistance, q.appendChild(s)
                }
            })) : U(q);
            for (var H = B(), Z = 0; Z < H.length; Z++) U(H[Z]);
            if (t.type) {
                var M = !1;
                for (var R in a)
                    if (t.type === R) { M = !0; break } if (!M) return i("Unknown alert type: " + t.type), !1;
                var $ = e.querySelector("." + o.icon + "." + a[t.type]);
                if (D($), t.animation) switch (t.type) {
                    case "success":
                        I($, "swal2-animate-success-icon"), I($.querySelector(".swal2-success-line-tip"), "swal2-animate-success-line-tip"), I($.querySelector(".swal2-success-line-long"), "swal2-animate-success-line-long");
                        break;
                    case "error":
                        I($, "swal2-animate-error-icon"), I($.querySelector(".swal2-x-mark"), "swal2-animate-x-mark")
                }
            }
            var K = T();
            t.imageUrl ? (K.setAttribute("src", t.imageUrl), K.setAttribute("alt", t.imageAlt), D(K), t.imageWidth ? K.setAttribute("width", t.imageWidth) : K.removeAttribute("width"), t.imageHeight ? K.setAttribute("height", t.imageHeight) : K.removeAttribute("height"), K.className = o.image, t.imageClass && I(K, t.imageClass)) : U(K), t.showCancelButton ? h.style.display = "inline-block" : U(h), t.showConfirmButton ? Q(x, "display") : U(x), t.showConfirmButton || t.showCancelButton ? D(g) : U(g), x.innerHTML = t.confirmButtonText, h.innerHTML = t.cancelButtonText, x.setAttribute("aria-label", t.confirmButtonAriaLabel), h.setAttribute("aria-label", t.cancelButtonAriaLabel), t.buttonsStyling && (x.style.backgroundColor = t.confirmButtonColor, h.style.backgroundColor = t.cancelButtonColor), x.className = o.confirm, I(x, t.confirmButtonClass), h.className = o.cancel, I(h, t.cancelButtonClass), t.buttonsStyling ? (I(x, o.styled), I(h, o.styled)) : (X(x, o.styled), X(h, o.styled), x.style.backgroundColor = x.style.borderLeftColor = x.style.borderRightColor = "", h.style.backgroundColor = h.style.borderLeftColor = h.style.borderRightColor = ""), !0 === t.animation ? X(e, o.noanimation) : I(e, o.noanimation), t.showLoaderOnConfirm && !t.preConfirm && r("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://limonte.github.io/sweetalert2/#ajax-request")
        },
        x = function() { null === y.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (y.previousBodyPadding = document.body.style.paddingRight, document.body.style.paddingRight = F() + "px") },
        h = function() {
            if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !M(document.body, o.iosfix)) {
                var n = document.body.scrollTop;
                document.body.style.top = -1 * n + "px", I(document.body, o.iosfix)
            }
        },
        k = function n() {
                ...
                return new Promise(function(t, e) {
                    ...
                    for (var d = function(t) {
                            if (r.showLoaderOnConfirm && n.showLoading(), r.preConfirm) {
                                ...
                                r.expectRejections ? e.then(function(n) { return a(n || t) }, function(t) { n.hideLoading(), t && n.showValidationError(t) }) : e.then(function(e) { K(q()) ? n.hideLoading() : a(e || t) }, function(n) { return c(n) })
                            } else a(t)
                        }, b = function(t) {
                                    ...
                                    if (p && n.isVisible())
                                        if (n.disableButtons(), r.input) {
                                            ...
                                            if (r.inputValidator) {
                                                ...
                                                r.expectRejections ? m.then(function() { n.enableButtons(), n.enableInput(), d(f) }, function(t) { n.enableButtons(), n.enableInput(), t && n.showValidationError(t) }) : m.then(function(t) { n.enableButtons(), n.enableInput(), t ? n.showValidationError(t) : d(f) }, function(n) { return c(n) })
                                            } else d(f)
                                        } else d(!0);
                    ...
                    N().onclick = function() { l("close") }, r.toast ? k.onclick = function(t) { t.target !== k || r.showConfirmButton || r.showCancelButton || r.allowOutsideClick && (n.closePopup(r.onClose), l("overlay")) } : w.onclick = function(n) { n.target === w && r.allowOutsideClick && l("overlay") };
                    var B = V(),
                        P = j(),
                        Z = O();
                    r.reverseButtons ? P.parentNode.insertBefore(Z, P) : P.parentNode.insertBefore(P, Z);
                    var W = function(n, t) {
                        for (var e = Y(r.focusCancel), o = 0; o < e.length; o++) {
                            (n += t) === e.length ? n = 0 : -1 === n && (n = e.length - 1);
                            var a = e[n];
                            if (K(a)) return a.focus()
                        }
                    };
                    m || (f = window.onkeydown, m = !0, window.onkeydown = function(t) {
                        var e = t || window.event;
                        if ("Enter" !== e.key || e.isComposing)
                            if ("Tab" === e.key) {
                                for (var o = e.target || e.srcElement, a = Y(r.focusCancel), s = -1, i = 0; i < a.length; i++)
                                    if (o === a[i]) { s = i; break } e.shiftKey ? W(s, -1) : W(s, 1), e.stopPropagation(), e.preventDefault()
                            } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === P && K(Z) ? Z.focus() : document.activeElement === Z && K(P) && P.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== r.allowEscapeKey || l("esc");
                        else if (e.target === u()) {
                        ...
                        t.innerHTML = n, D(t);
                        var e = u();
                        e && (e.setAttribute("aria-invalid", !0), e.setAttribute("aria-describedBy", o.validationerror), R(e), I(e, o.inputerror))
                    }, n.resetValidationError = function() {
                        var n = q();
                        U(n);
                        var t = u();
                        t && (t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedBy"), X(t, o.inputerror))
                    }, n.getProgressSteps = function() { return r.progressSteps }, n.setProgressSteps = function(n) { r.progressSteps = n, g(r) }, n.showProgressSteps = function() { D(z()) }, n.hideProgressSteps = function() { U(z()) }, n.enableButtons(), n.hideLoading(), n.resetValidationError(), r.input && I(document.body, o["has-input"]);
                    for (var Q = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], J = void 0, F = 0; F < Q.length; F++) {
                        var G = o[Q[F]],
                            nn = $(k, G);
                        if (J = u(Q[F])) {
                            for (var tn in J.attributes)
                                if (J.attributes.hasOwnProperty(tn)) { var en = J.attributes[tn].name; "type" !== en && "value" !== en && J.removeAttribute(en) } for (var on in r.inputAttributes) J.setAttribute(on, r.inputAttributes[on])
                        }
                        nn.className = G, r.inputClass && I(nn, r.inputClass), U(nn)
                    }
                    var an = void 0;
                    switch (r.input) {
                        case "text":
                        ...
                        case "tel":
                        case "url":
                            (J = $(k, o.input)).value = r.inputValue, J.placeholder = r.inputPlaceholder, J.type = r.input, D(J);
                            break;
                        case "file":
                            (J = $(k, o.file)).placeholder = r.inputPlaceholder, J.type = r.input, D(J);
                            break;
                        case "range":
                            var sn = $(k, o.range),
                                rn = sn.querySelector("input"),
                                ln = sn.querySelector("output");
                            rn.value = r.inputValue, rn.type = r.input, ln.value = r.inputValue, D(sn);
                            break;
                        case "select":
                            var cn = $(k, o.select);
                        ...
                        case "checkbox":
                            ...
                            fn.length && dn.removeChild(fn[0]), (fn = document.createElement("span")).innerHTML = r.inputPlaceholder, dn.appendChild(fn), D(dn);
                            break;
                        case "textarea":
                            var mn = $(k, o.textarea);
                            mn.value = r.inputValue, mn.placeholder = r.inputPlaceholder, D(mn);
                            break;
                        case null:
                            break;
                        default:
                    ...
                    "select" !== r.input && "radio" !== r.input || (r.inputOptions instanceof Promise ? (n.showLoading(), r.inputOptions.then(function(t) { n.hideLoading(), an(t) })) : "object" === p(r.inputOptions) ? an(r.inputOptions) : i("Unexpected type of inputOptions! Expected object or Promise, got " + p(r.inputOptions))),
                        function(n, t, e) {
                            var a = S(),
                                s = A();
                            null !== t && "function" == typeof t && t(s), n ? (I(s, o.show), I(a, o.fade), X(s, o.hide)) : X(s, o.fade), D(s), a.style.overflowY = "hidden", _ && !M(s, o.noanimation) ? s.addEventListener(_, function n() { s.removeEventListener(_, n), a.style.overflowY = "auto" }) : a.style.overflowY = "auto", I(document.documentElement, o.shown), I(document.body, o.shown), I(a, o.shown), H() && (x(), h()), y.previousActiveElement = document.activeElement, null !== e && "function" == typeof e && setTimeout(function() { e(s) })
                        }(r.animation, r.onBeforeOpen, r.onOpen), r.toast || (r.allowEnterKey ? r.focusCancel && K(Z) ? Z.focus() : r.focusConfirm && K(P) ? P.focus() : W(-1, 1) : document.activeElement && document.activeElement.blur()), S().scrollTop = 0
                })
            }
        };
    k.isVisible = function() { return !!A() }, k.queue = function(n) {
        w = n;
        var t = function() { w = [], document.body.removeAttribute("data-swal2-queue-step") },
            e = [];
        return new Promise(function(n, o) {! function o(a, s) { a < w.length ? (document.body.setAttribute("data-swal2-queue-step", a), k(w[a]).then(function(r) { void 0 !== r.value ? (e.push(r.value), o(a + 1, s)) : (t(), n({ dismiss: r.dismiss })) })) : (t(), n({ value: e })) }(0) })
    }, k.getQueueStep = function() { return document.body.getAttribute("data-swal2-queue-step") }, k.insertQueueStep = function(n, t) { return t && t < w.length ? w.splice(t, 0, n) : w.push(n) }, k.deleteQueueStep = function(n) { void 0 !== w[n] && w.splice(n, 1) }, k.close = k.closePopup = k.closeModal = k.closeToast = function(n) {
        var t = S(),
            e = A();
        if (e) {
            X(e, o.show), I(e, o.hide), clearTimeout(e.timeout), Z() || (J(), window.onkeydown = f, m = !1);
            var a = function() {
                t.parentNode && t.parentNode.removeChild(t), X(document.documentElement, o.shown), X(document.body, o.shown), X(document.body, o["no-backdrop"]), X(document.body, o["has-input"]), X(document.body, o["toast-shown"]), H() && (null !== y.previousBodyPadding && (document.body.style.paddingRight = y.previousBodyPadding, y.previousBodyPadding = null), function() {
                    if (M(document.body, o.iosfix)) {
                        var n = parseInt(document.body.style.top, 10);
                        X(document.body, o.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * n
                    }
                }())
            };
            _ && !M(e, o.noanimation) ? e.addEventListener(_, function n() { e.removeEventListener(_, n), M(e, o.hide) && a() }) : a(), null !== n && "function" == typeof n && setTimeout(function() { n(e) })
        }
    }, k.clickConfirm = function() { return j().click() }, k.clickCancel = function() { return O().click() }, k.showLoading = k.enableLoading = function() {
        var n = A();
        n || k(""), n = A();
        var t = V(),
            e = j(),
            a = O();
        D(t), D(e, "inline-block"), I(t, o.loading), I(n, o.loading), e.disabled = !0, a.disabled = !0, n.setAttribute("aria-busy", !0), n.focus()
    ...
    }, k.resetDefaults = function() { d = u({}, n) }, k.adaptInputValidator = function(n) { return function(t, e) { return n.call(this, t, e).then(function() {}, function(n) { return n }) } }, k.noop = function() {}, k.version = "7.0.5", k.default = k;
    var y = { previousActiveElement: null, previousBodyPadding: null },
        v = function(n) {
            var t = S();
            t && (t.parentNode.removeChild(t), X(document.body, o["no-backdrop"]), X(document.body, o["has-input"]), X(document.body, o["toast-shown"])); {
                if ("undefined" != typeof document) {
                    var e = document.createElement("div");
                    e.className = o.container, e.innerHTML = C;
                    ...
                    var w = function() { k.isVisible() && k.resetValidationError() };
                    return s.oninput = w, r.onchange = w, p.onchange = w, u.onchange = w, d.oninput = w, l.oninput = function() { w(), c.value = l.value }, l.onchange = function() { w(), l.previousSibling.value = l.value }, a
                }
        ...
        S = function() { return document.body.querySelector("." + o.container) },
        A = function() { return S() ? S().querySelector("." + o.popup) : null },
        B = function() { return A().querySelectorAll("." + o.icon) },
        P = function(n) { return S() ? S().querySelector("." + n) : null },
        E = function() { return P(o.title) },
        L = function() { return P(o.content) },
        T = function() { return P(o.image) },
        z = function() { return P(o.progresssteps) },
        q = function() { return P(o.validationerror) },
        j = function() { return P(o.confirm) },
        O = function() { return P(o.cancel) },
        V = function() { return P(o.buttonswrapper) },
        N = function() { return P(o.close) },
        Y = function() {
            var n = Array.from(A().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function(n, t) { return n = parseInt(n.getAttribute("tabindex")), t = parseInt(t.getAttribute("tabindex")), n > t ? 1 : n < t ? -1 : 0 }),
                t = Array.prototype.slice.call(A().querySelectorAll('button, input:not([type=hidden]), textarea, select, a, [tabindex="0"]'));
            return function(n) { var t = []; for (var e in n) - 1 === t.indexOf(n[e]) && t.push(n[e]); return t }(n.concat(t))
        },
        H = function() { return !document.body.classList.contains(o["toast-shown"]) },
        Z = function() { return document.body.classList.contains(o["toast-shown"]) },
        M = function(n, t) { return !!n.classList && n.classList.contains(t) },
        R = function(n) {
        ...
        I = function(n, t) { if (n && t) { t.split(/\s+/).filter(Boolean).forEach(function(t) { n.classList.add(t) }) } },
        X = function(n, t) { if (n && t) { t.split(/\s+/).filter(Boolean).forEach(function(t) { n.classList.remove(t) }) } },
        $ = function(n, t) {
            for (var e = 0; e < n.childNodes.length; e++)
                if (M(n.childNodes[e], t)) return n.childNodes[e]
        },
        D = function(n, t) { t || (t = n === A() || n === V() ? "flex" : "block"), n.style.opacity = "", n.style.display = t },
        U = function(n) { n.style.opacity = "", n.style.display = "none" },
        W = function(n) { for (; n.firstChild;) n.removeChild(n.firstChild) },
        K = function(n) { return n.offsetWidth || n.offsetHeight || n.getClientRects().length },
        Q = function(n, t) { n.style.removeProperty ? n.style.removeProperty(t) : n.style.removeAttribute(t) },
        _ = function() {
        ...
        J = function() {
            if (y.previousActiveElement && y.previousActiveElement.focus) {
                var n = window.scrollX,
                    t = window.scrollY;
                y.previousActiveElement.focus(), n && t && window.scrollTo(n, t)
            }
        },
        F = function() {
